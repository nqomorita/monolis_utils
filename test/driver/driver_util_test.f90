...
contains
  ...
  subroutine monolis_driver_get_arg_dbc_all_test()
    ...
    call monolis_test_check_eq_L1("monolis_driver_get_arg_dbc_all_test case 1", is_get, .true.)

    call monolis_test_check_eq_I1("monolis_driver_get_arg_dbc_all_test case 2", n_dof, 2)

    r_ans(1) = 10.0d0
    r_ans(2) = 20.0d0

    call monolis_test_check_eq_R ("monolis_driver_get_arg_dbc_all_test case 3", val, r_ans)
