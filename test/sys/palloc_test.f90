...
contains
  ...
  subroutine monolis_palloc_I_1d_test()
    ...
    call monolis_std_log_string("monolis_palloc_I_1d_test")

    call monolis_palloc_I_1d(a, 5)

    if(.not. associated(a))then
      call monolis_test_assert_fail("monolis_palloc_I_1d_test", "")
    endif
    ...
    call monolis_test_check_eq_I("monolis_palloc_I_1d_test", a, b)
  ...
  subroutine monolis_pdealloc_I_1d_test()
    ...
    call monolis_std_log_string("monolis_pdealloc_I_1d_test")
    ...
    if(associated(a))then
      call monolis_test_assert_fail("monolis_pdealloc_I_1d_test", "")
    else
      call monolis_test_assert_pass("monolis_pdealloc_I_1d_test")
    endif
  ...
  subroutine monolis_palloc_R_1d_test()
    ...
    call monolis_std_log_string("monolis_palloc_R_1d_test")

    call monolis_palloc_R_1d(a, 5)

    if(.not. associated(a))then
      call monolis_test_assert_fail("monolis_palloc_R_1d_test", "")
    endif
    ...
    call monolis_test_check_eq_R("monolis_palloc_R_1d_test", a, b)
  ...
  subroutine monolis_pdealloc_R_1d_test()
    ...
    call monolis_std_log_string("monolis_pdealloc_R_1d_test")
    ...
    if(associated(a))then
      call monolis_test_assert_fail("monolis_pdealloc_R_1d_test", "")
    else
      call monolis_test_assert_pass("monolis_pdealloc_R_1d_test")
    endif
  ...
  subroutine monolis_palloc_C_1d_test()
    ...
    call monolis_std_log_string("monolis_palloc_C_1d_test")

    call monolis_palloc_C_1d(a, 5)

    if(.not. associated(a))then
      call monolis_test_assert_fail("monolis_palloc_C_1d_test", "")
    endif
    ...
    call monolis_test_check_eq_C("monolis_palloc_C_1d_test", a, b)
  ...
  subroutine monolis_pdealloc_C_1d_test()
    ...
    call monolis_std_log_string("monolis_pdealloc_C_1d_test")
    ...
    if(associated(a))then
      call monolis_test_assert_fail("monolis_pdealloc_C_1d_test", "")
    else
      call monolis_test_assert_pass("monolis_pdealloc_C_1d_test")
    endif
