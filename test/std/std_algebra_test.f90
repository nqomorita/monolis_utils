...
contains
  ...
  subroutine monolis_get_inverse_matrix_R_test()
    ...
    call monolis_std_log_string("monolis_get_inverse_matrix_R_test")
    ...
    call monolis_test_check_eq_R("monolis_get_inverse_matrix_R_test 1", b(:,1), c(:,1))
    call monolis_test_check_eq_R("monolis_get_inverse_matrix_R_test 1", b(:,2), c(:,2))
    call monolis_test_check_eq_R("monolis_get_inverse_matrix_R_test 1", b(:,3), c(:,3))
  ...
  subroutine monolis_get_inverse_matrix_R_2d_test()
    ...
    call monolis_std_log_string("monolis_get_inverse_matrix_R_2d_test")
    ...
    call monolis_test_check_eq_R ("monolis_get_inverse_matrix_R_2d_test 1", b(:,1), c(:,1))
    call monolis_test_check_eq_R ("monolis_get_inverse_matrix_R_2d_test 1", b(:,2), c(:,2))
    call monolis_test_check_eq_R1("monolis_get_inverse_matrix_R_2d_test 1", det, 1.0d0)
  ...
  subroutine monolis_get_inverse_matrix_R_3d_test()
    ...
    call monolis_std_log_string("monolis_get_inverse_matrix_R_3d_test")
    ...
    call monolis_test_check_eq_R ("monolis_get_inverse_matrix_R_3d_test 1", b(:,1), c(:,1))
    call monolis_test_check_eq_R ("monolis_get_inverse_matrix_R_3d_test 1", b(:,2), c(:,2))
    call monolis_test_check_eq_R ("monolis_get_inverse_matrix_R_3d_test 1", b(:,3), c(:,3))
    call monolis_test_check_eq_L1("monolis_get_inverse_matrix_R_3d_test 1", is_fail, .true.)
  ...
  subroutine monolis_normalize_cross_product_R_3d_test()
    ...
    call monolis_std_log_string("monolis_normalize_cross_product_R_3d_test")
    ...
    call monolis_test_check_eq_R ("monolis_normalize_cross_product_R_3d_test 1", v3, v4)
    ...
    call monolis_test_check_eq_R ("monolis_normalize_cross_product_R_3d_test 2", v3, v4)
    ...
    call monolis_test_check_eq_R ("monolis_normalize_cross_product_R_3d_test 3", v3, v4)
  ...
  subroutine monolis_cross_product_R_3d_test()
    ...
    call monolis_std_log_string("monolis_cross_product_R_3d_test")
    ...
    call monolis_test_check_eq_R ("monolis_cross_product_R_3d_test 1", v3, v4)
    ...
    call monolis_test_check_eq_R ("monolis_cross_product_R_3d_test 2", v3, v4)
    ...
    call monolis_test_check_eq_R ("monolis_cross_product_R_3d_test 3", v3, v4)
  ...
  subroutine monolis_normalize_vector_R_test()
    ...
    call monolis_std_log_string("monolis_normalize_vector_R_test")
    ...
    call monolis_test_check_eq_R ("monolis_normalize_vector_R_test 1", v2, v3)
  ...
  subroutine monolis_get_l2_norm_R_test()
    ...
    call monolis_std_log_string("monolis_get_l2_norm_R_test")
