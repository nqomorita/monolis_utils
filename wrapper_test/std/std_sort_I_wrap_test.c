...
void monolis_sort_I_warp_test()
{
  ...
  monolis_qsort_I_1d(a, 5, 1, 3);

  monolis_test_check_eq_I1("monolis_sort_I_warp_test 3a_c", a[0], 5);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 3a_c", a[1], 2);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 3a_c", a[2], 3);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 3a_c", a[3], 4);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 3a_c", a[4], 1);
  ...
  monolis_qsort_I_2d(a, b, 5, 1, 3);

  monolis_test_check_eq_I1("monolis_sort_I_warp_test 7_c", a[0], 5);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 7_c", a[1], 2);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 7_c", a[2], 3);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 7_c", a[3], 4);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 7_c", a[4], 1);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 7_c", b[0], 50);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 7_c", b[1], 20);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 7_c", b[2], 30);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 7_c", b[3], 40);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 7_c", b[4], 10);
  ...
  monolis_bsearch_I(a, 5, 0, 4, 20, &idx);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 7_c", idx, 1);

  monolis_bsearch_I(a, 5, 0, 4, 10, &idx);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 7_c", idx, 0);

  monolis_bsearch_I(a, 5, 0, 2, 40, &idx);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 7_c", idx, -1);

  monolis_bsearch_I(a, 5, 1, 3, 40, &idx);
  monolis_test_check_eq_I1("monolis_sort_I_warp_test 7_c", idx, 3);
