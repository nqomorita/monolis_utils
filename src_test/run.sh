...
../bin/monolis_h_refiner_tet -in ${INP}/node.tet.2elem.dat -ie ${INP}/elem.tet.2elem.dat -on ${OUT}/node.ref.h.tet.dat -oe ${OUT}/elem.ref.h.tet.dat

../bin/monolis_h_refiner_hex -in ${INP}/node.hex.2elem.dat -ie ${INP}/elem.hex.2elem.dat -on ${OUT}/node.ref.h.hex.dat -oe ${OUT}/elem.ref.h.hex.dat
