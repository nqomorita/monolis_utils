...
contains
  ...
  subroutine monolis_get_global_input_file_name_test()
    ...
    call monolis_std_log_string("monolis_get_global_input_file_name")
  ...
  subroutine monolis_get_local_input_file_name_test()
    ...
    call monolis_std_log_string("monolis_get_local_input_file_name")
  ...
  subroutine monolis_get_global_output_file_name_test()
    ...
    call monolis_std_log_string("monolis_get_global_output_file_name")
  ...
  subroutine monolis_get_local_output_file_name_test()
    ...
    call monolis_std_log_string("monolis_get_local_output_file_name")
  ...
  subroutine monolis_get_local_output_file_name_by_domain_id_test()
    ...
    call monolis_std_log_string("monolis_get_output_file_name_by_domain_id")
