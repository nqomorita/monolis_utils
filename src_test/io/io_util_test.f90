...
contains
  ...
  subroutine monolis_check_fortran_1_origin_elem_test()
    ...
    call monolis_std_log_string("monolis_check_fortran_1_origin_elem_test")
    ...
    call monolis_test_check_eq_L1("monolis_check_fortran_1_origin_elem_test 1", is_1_origin, .true.)
    ...
    call monolis_test_check_eq_L1("monolis_check_fortran_1_origin_elem_test 2", is_1_origin, .false.)
  ...
  subroutine monolis_check_fortran_1_origin_graph_test()
    ...
    call monolis_std_log_string("monolis_check_fortran_1_origin_graph_test")
    ...
    call monolis_test_check_eq_L1("monolis_check_fortran_1_origin_graph_test 1", is_1_origin, .true.)
    ...
    call monolis_test_check_eq_L1("monolis_check_fortran_1_origin_graph_test 1", is_1_origin, .false.)
