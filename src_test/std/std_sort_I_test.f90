...
contains
  ...
  subroutine monolis_qsort_I_1d_test()
    ...
    call monolis_test_check_eq_I("monolis_qsort_I_1d case 4", a, b)
  ...
  subroutine monolis_qsort_I_2d_test()
    ...
    call monolis_qsort_I_2d(a, b, 2, 4)
    ...
    call monolis_test_check_eq_I("monolis_qsort_I_2d case 4", a, c)
    call monolis_test_check_eq_I("monolis_qsort_I_2d case 4", b, d)
  ...
  subroutine monolis_bsearch_I_test()
    ...
    call monolis_bsearch_I(a, 2, 4, 40, idx)

    call monolis_test_check_eq_I1("monolis_bsearch_I case 4", idx, 4)
