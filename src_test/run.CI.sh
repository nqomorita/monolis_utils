...
./monolis_utils_test -test_i 1 -test_r 2.0 -test_s test_string -d driver -i a.txt -o b.txt -in c.txt -ie d.txt -n 2 2 10.0 20.0 30.0 40.0

mpirun --oversubscribe --allow-run-as-root -np 2 ./monolis_utils_test -test_i 1 -test_r 2.0 -test_s test_string -d driver -i a.txt -o b.txt -in c.txt -ie d.txt -n 2 2 10.0 20.0 30.0 40.0
